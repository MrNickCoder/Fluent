...
function Element:New(Idx, Config)
	...
	Searchbox.Frame.Position = UDim2.new(5, 0.5, 0, 5)
	Searchbox.Frame.AnchorPoint = Vector2.new(0, 0)
	Searchbox.Frame.Size = UDim2.new(1, -10, 0, 30)
	...
	Creator.AddSignal(Searchbox.Input:GetPropertyChangedSignal("Text"), function()
		local Text = Searchbox.Input.Text;
		if #Text >= 29 then
			Text = Text:sub(1, #Text - 2);
			Searchbox.Input.Text = (Text == '' and '' or Text);
		end;
		Dropdown:BuildDropdownList(Searchbox.Input.Text);
	end)
